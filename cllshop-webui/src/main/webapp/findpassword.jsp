    ...
    $(document).ready(function () {
        ...
        $("#getCodeBtn").click(function () {
            ...
            if(tips.indexOf("失败")==-1&&tips!=""){
                alert("请检查邮箱格式或者该邮箱是否为注册邮箱");
            }else{
                $.ajax({
                    url:"${pageContext.request.contextPath}/user/checkEmail1",
                    data:data,
                    dataType:"json",
                    type:"post",
                    async:true,
            ...
            <div class="col-md-6 login-right">
                <form class="form-horizontal"  method="post">
                    <fieldset>
                        ...
                        <div class="form-group">
                            <label class="control-label" for="email">注册邮箱</label><br/>
