    ...
    <div class="layui-row">
        <div class="layui-col-lg12">
            <fieldset class="layui-elem-field">
                <legend>商品管理 - 编辑商品</legend>
                <div class="layui-field-box">
                    <form class="layui-form" action="${pageContext.request.contextPath}/product/edit" method="post">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" value="${product.name}" name="name" required lay-verify="required" placeholder="请输入商品名称"
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" value="${product.description}" name="description" required lay-verify="required" placeholder="请输入商品描述"
                                       autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" value="${product.price}" name="price" required lay-verify="required" placeholder="请输入价格"
                                       autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                ...
                                <input type="hidden" id="img_pic" name="images" value="${product.images}"/>
                                <div class="layui-upload-list">
                                    <img class="layui-upload-img" width="100px" height="80px" id="demo1" src="${product.images}"/>
                                    <p id="demoText"></p>
                                </div>
                            </div>
                        </div>
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" value="${product.stock}" name="stock" required lay-verify="required" placeholder="请输入库存数量"
                                       autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <select id="btype" name="bigtypeid" lay-filter="btype">
                                    ...
                                    <c:forEach items="${bigTypes}" var="bigtype">
                                        <c:choose>
                                            <c:when test="${bigtype.id==product.bigType.id }">
                                                <option value="${bigtype.id }" selected="selected">${bigtype.name }</option>
                                            </c:when>
                                            <c:otherwise>
                            ...
                            <div class="layui-input-inline">
                                <select name="smalltypeid" id="stype" class="field">
                                    <option value="">请选择类别</option>
                                    <option value="${product.smallType.id}" selected>${product.smallType.name}</option>
                                </select>
                            </div>
                        </div>
                        <!--类别-->
